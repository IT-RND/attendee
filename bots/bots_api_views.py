...
class BotDetailView(APIView):
    ...
    @extend_schema(
        ...
        description="Updates a bot. The join_at, meeting_url, bot_image and recording_settings fields can only be updated when the bot is in the scheduled state. The metadata field can be updated at any time.",
